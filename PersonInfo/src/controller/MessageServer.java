...
/**
 * This is sort of simulated message
 */
public class MessageServer implements Iterable<Message>{
    ...
    public MessageServer(){
        ...
        list = new ArrayList<Message>();
        list.add(new Message("How many times can a man look up", "Before he can see the sky? More on that story later."));
        list.add(new Message("Company policy", "Please do not talk to the journalists outside."));
        list.add(new Message("New update schedule", "From now on we will be updating the codebase every night at 1 a.m."));
        messages.put(3, list);
        ...
        list.add(new Message("Vending machine", "The coffee in the vending machine has been found to be contaminated with faeces. Please moderate your intake."));
        messages.put(4, list);
    }

    public void setSelectServers(Set<Integer> servers){
        selected.clear();
